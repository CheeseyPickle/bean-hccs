...
const CastSkills =
    ...
    $skills`Advanced Saucecrafting, Get Big, Feel Excitement, The Magical Mojomuscular Melody, Manicotti Meditation, Blood Bubble, Carol of the Hells, Feel Peaceful, Elemental Saucesphere, Feel Nervous, Singer's Faithful Ocelot, Blood Bond, Leash of Linguini, Empathy of the Newt, Ur-Kel's Aria of Annoyance, Drescher's Annoying Noise, Pride of the Puffin, Carol of the Thrills`
        .map((s) => ({
            name: s.name,
            ready: () => myMp() > mpCost(s),
            do: (): void => {
